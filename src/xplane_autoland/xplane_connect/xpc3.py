# XPlaneConnect developed by NASA
# Available here: https://github.com/nasa/XPlaneConnect/blob/master/Python3/src/xpc/__init__.py
# TODO: try updating to the latest version
import socket
import struct
import math
