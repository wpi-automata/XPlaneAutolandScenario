...
if __name__ == '__main__':
    ...
    today = date.today()
    save_dir = Path(f"{repo_dir}/errors/{today.year}-{today.month}-{today.day}/LL12464-12-6")
    ...
    dataset = AutolandImageDataset(f"{data_dir}/processed-states.csv", f"{data_dir}/images")
